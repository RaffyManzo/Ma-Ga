#!/usr/bin/env python3
"""Campaign-specific validator for one MA-GA V2 scenario instance."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--spec", default=str(Path(__file__).with_name("final_campaign_v2_spec.json")))
